...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "description", content: "Gestión de honorarios y cuenta corriente del estudio" },
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){var t=localStorage.getItem('cifra-theme');if(t==='dark'){document.documentElement.classList.add('dark')}})()`,
          }}
        />
        <HeadContent />
      </head>
