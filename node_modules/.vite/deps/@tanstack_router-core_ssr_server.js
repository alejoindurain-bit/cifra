...
import { B as decodePath, Z as dehydrateSsrMatchId, i as _getRenderedMatches, nt as rootRouteId } from "./development-dYPgRWGq.js";
import { createMemoryHistory } from "./@tanstack_history.js";
import { t as mergeHeaders } from "./headers-DquMe5Qr.js";
import { _ as getStylesheetHref, c as GLOBAL_TSR, f as createInlineCssPlaceholderAsset, l as TSR_SCRIPT_BARRIER_ID, p as createInlineCssStyleAsset, s as makeSsrSerovalPlugin, t as defaultSerovalPlugins } from "./seroval-plugins-EyeYdq2b.js";
import { crossSerializeStream, getCrossReferenceHeader } from "./seroval.js";
...
function getPreparedMatchedManifestRoutes(manifest, matches, cacheKey) {
	return prepareMatchedManifestRoutes(manifest, matches);
}
...
function attachRouterServerSsrUtils({ router, manifest, getRequestAssets }) {
	...
	const serverSsr = {
		...
		dehydrate: async (opts) => {
			if (_dehydrated) throw new Error("Invariant failed: router is already dehydrated!");
...
//#endregion
//#region browser-external:node:stream/web
var require_web = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:stream/web" has been externalized for browser compatibility. Cannot access "node:stream/web.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region browser-external:node:stream
var require_browser_external_node_stream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:stream" has been externalized for browser compatibility. Cannot access "node:stream.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region node_modules/@tanstack/router-core/dist/esm/ssr/transformStreamWithRouter.js
var import_web = require_web();
var import_browser_external_node_stream = require_browser_external_node_stream();
...
function transformPipeableStreamWithRouter(router, routerStream, opts) {
	return import_browser_external_node_stream.Readable.fromWeb(transformStreamWithRouter(router, import_browser_external_node_stream.Readable.toWeb(routerStream), opts));
}
