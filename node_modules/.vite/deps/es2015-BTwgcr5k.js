...
import { n as useLayoutEffect2, r as composeEventHandlers } from "./dist-jKDs46CV.js";
import { n as dispatchDiscreteCustomEvent, t as Primitive } from "./dist-DWhXw1Bo.js";
import { t as useCallbackRef$1 } from "./dist-Bmg4-EZr.js";
...
var DismissableLayer = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$3(function DismissableLayer2(props, forwardedRef) {
	...
	import_react.useEffect(() => {
		const handleUpdate = /* @__PURE__ */ __name$3(() => force({}), "handleUpdate");
...
__name$3(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = /* @__PURE__ */ __name$3(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
	...
	import_react.useEffect(() => {
		...
		__name$3(resetOutsideInteraction, "resetOutsideInteraction");
		function isOutsideInteractionIntercepted() {
			return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
		}
		__name$3(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
		...
		__name$3(handleInteractionCapture, "handleInteractionCapture");
		function handleInteractionBubble(event) {
			if (isPointerDownOutsideRef.current) interceptedOutsideInteractionEventsRef.current.set(event.type, false);
		}
		__name$3(handleInteractionBubble, "handleInteractionBubble");
		const handlePointerDown = /* @__PURE__ */ __name$3((event) => {
			if (event.target && !isPointerInsideReactTreeRef.current) {
				...
				__name$3(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
	...
	return { onPointerDownCapture: /* @__PURE__ */ __name$3(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture") };
}
__name$3(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
	const handleFocusOutside = useCallbackRef$1(onFocusOutside);
	const isFocusInsideReactTreeRef = import_react.useRef(false);
	import_react.useEffect(() => {
		const handleFocus = /* @__PURE__ */ __name$3((event) => {
	...
	return {
		onFocusCapture: /* @__PURE__ */ __name$3(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
		onBlurCapture: /* @__PURE__ */ __name$3(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
	};
}
__name$3(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
	const event = new CustomEvent(CONTEXT_UPDATE);
	document.dispatchEvent(event);
}
__name$3(dispatchUpdate, "dispatchUpdate");
...
__name$3(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
//#endregion
...
//#endregion
export { FocusScope as a, Portal as i, ReactRemoveScroll as n, DismissableLayer as o, useFocusGuards as r, useDismissableLayerSurface as s, hideOthers as t };
