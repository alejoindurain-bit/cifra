import { C as SqliteDialect, G as Kysely, c as MssqlDialect, h as MysqlDialect, p as PostgresDialect, z as sql } from "./esm-fnVhvLXq.js";
import { capitalizeFirstLetter } from "./@better-auth_core_utils_string.js";
import { i as logger } from "./logger-boudjJNO.js";
import "./@better-auth_core_env.js";
import { n as createAdapterFactory } from "./adapter-Cr_IQSnZ.js";
...
var createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-BW9W1_Ps-BOv1yXcB.js");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-CjSWgp_E.js");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-BLC8LXE6-DQXRmMPz.js");
